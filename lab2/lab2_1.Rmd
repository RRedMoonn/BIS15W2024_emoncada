...
This action was not able to be done since there is a number missing from that list. NA does not have a value so you cannot perform the "mean" action with it.
