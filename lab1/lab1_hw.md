...
R s the scripting language. R studio is where I will be coding since it is the IDE. It is the software used to write R code. Essentially, R studio is the GUI, which allows the user to interact with the software using the R scripting language. It is like the notebook where one can write out the English language to create sentences and meanings. GitHub is a space to upload and share data with other programmers. This allows various programmers to work on the same project and be able to keep track of each other's progress. It allows for file management as well. For this class, it would  allow us to upload our homework.
