...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{anyNA}\NormalTok{(ynp}\SpecialCharTok{$}\NormalTok{packsize\_aug)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
  \FunctionTok{mean}\NormalTok{(ynp}\SpecialCharTok{$}\NormalTok{packsize\_aug, }\AttributeTok{na.rm=}\NormalTok{T)}
\end{Highlighting}
\end{Shaded}
